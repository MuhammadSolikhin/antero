...
INSERT INTO `club_info` (`id`, `club_name`, `instagram`, `tiktok`, `youtube`, `updated_at`, `background_image`) VALUES
	(1, 'Antero Taekwondo Club', 'https://www.instagram.com/anterotaekwondoclub?igsh=MW5jbml1MXNpdmpsaw==', 'https://www.tiktok.com/@anterotaekwondoclub?_r=1&_t=ZS-92W9R5hFtci', 'http://www.youtube.com/@anterotaekwondoclub238', '2026-03-12 15:47:09', 'bg_1773330429.jpg');
...
CREATE TABLE IF NOT EXISTS `coaches` (
  ...
  CONSTRAINT `fk_coach_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table db_prestasi_beladiri.coaches: ~8 rows (approximately)
INSERT INTO `coaches` (`id`, `nama_pelatih`, `riwayat_pelatihan`, `tingkatan`, `info_sertifikat`, `foto_pelatih`, `created_at`, `user_id`) VALUES
	(9, 'Nazhira Raka Putri', 'Pelatihan Dasar 2010, Pelatihan Lanjut 2020', 'DAN I', '-', '1768545531_WhatsApp Image 2026-01-16 at 13.38.19.jpeg', '2025-12-20 02:33:15', NULL),
	(10, 'Ribut Wahyudi', 'Pelatihan Dasar 2010, Pelatihan Lanjut 2021', 'DAN I', 'Sertifikat Coaching Clinic Pelatih Fisik Taekwondo Kyorugi', '1768286541_IMG-20260111-WA0137.jpg', '2025-12-20 02:33:15', NULL),
	(11, 'Ajeng Restu Arini', 'Pelatihan Dasar 2010, Pelatihan Lanjut 2022', 'DAN III', '-', '1768545239_WhatsApp Image 2026-01-16 at 13.32.56.jpeg', '2025-12-20 02:33:15', 21),
	(12, 'Eko Prasetyo', 'Pelatihan Dasar 2010, Pelatihan Lanjut 2023', 'DAN I', 'Sertifikat Pelatih Nasional Tahun 2023', '', '2025-12-20 02:33:15', 25),
	(13, 'Sri Wahyuni', 'Pelatihan Dasar 2010, Pelatihan Lanjut 2024', 'DAN I', 'Sertifikat Pelatih Nasional Tahun 2024', '', '2025-12-20 02:33:15', NULL),
	(14, 'Dzulqarnain Tsaqib', '-', 'DAN I', '-', '1768548616_WhatsApp Image 2026-01-16 at 14.01.57.jpeg', '2026-01-16 00:30:16', 22),
	(15, 'efbe', '-', 'DAN I', '', '', '2026-02-26 06:24:16', NULL),
	(16, 'pelatih 3', '', '', NULL, 'coach_24_1773331404.jpeg', '2026-03-12 15:59:59', 24);
...
INSERT INTO `dojangs` (`id`, `nama_dojang`, `alamat`, `google_maps`, `created_at`, `coach_id`) VALUES
	...
	(8, 'Asera One South Harapan Indah', 'Jl. Asera Boulevard, Pusaka Rakyat, Kec. Tarumajaya, Kabupaten Bekasi, Jawa Barat 17214', 'https://maps.app.goo.gl/R1qEpRkbm8jZJLJK7', '2025-12-20 02:26:47', 14),
...
-- Dumping data for table db_prestasi_beladiri.students: ~4 rows (approximately)
INSERT INTO `students` (`id`, `user_id`, `dojang_id`, `nama_lengkap`, `tempat_lahir`, `tanggal_lahir`, `tingkatan_sabuk`, `status`, `foto_sertifikat`, `alamat_domisili`, `created_at`, `is_deleted`, `deleted_at`) VALUES
	(1, 2, 8, 'Ribut Wahyudi', 'Jakarta', '1990-01-06', 'DAN I', 'tidak aktif', 'cert_2_1768285620.pdf', 'Panjibuwono City, Cluster Sriwedari Blok CS-6/32 Babelan, Bekasi Utara', '2025-12-17 06:26:14', 0, NULL),
	(3, 4, 2, 'Rudi Hartono', 'Jakarta', '2007-08-17', 'Putih/Geup-10', 'aktif', NULL, 'Jl. Contoh No. 3', '2025-12-17 06:26:14', 0, NULL),
	(16, 19, 1, 'Dzulqarnain Tsaqib Kuncahyo', 'Jakarta', '2008-01-09', 'DAN I', 'aktif', 'cert_19_1768548939.jpeg', 'Jln Lapangan Roos III No.1 RT 003/005, Bukit Duri Tebet, Jakarta Selatan', '2026-01-16 00:35:39', 0, NULL),
	(17, 20, 1, 'test', 'test', '2026-02-12', 'Putih/Geup-10', 'aktif', NULL, 'rjnrfr', '2026-02-11 16:22:13', 1, '2026-02-11 23:22:23');
...
-- Dumping structure for table db_prestasi_beladiri.student_dojang_history
CREATE TABLE IF NOT EXISTS `student_dojang_history` (
  `id` int NOT NULL AUTO_INCREMENT,
  `student_id` int NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `student_id` (`student_id`),
  KEY `old_dojang_id` (`old_dojang_id`),
  KEY `new_dojang_id` (`new_dojang_id`),
  CONSTRAINT `student_dojang_history_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE,
  CONSTRAINT `student_dojang_history_ibfk_2` FOREIGN KEY (`old_dojang_id`) REFERENCES `dojangs` (`id`) ON DELETE SET NULL,
  CONSTRAINT `student_dojang_history_ibfk_3` FOREIGN KEY (`new_dojang_id`) REFERENCES `dojangs` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table db_prestasi_beladiri.student_dojang_history: ~0 rows (approximately)
INSERT INTO `student_dojang_history` (`id`, `student_id`, `old_dojang_id`, `new_dojang_id`, `change_date`, `reason`) VALUES
	(1, 16, 13, 1, '2026-01-26 11:13:09', NULL);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `role` enum('admin','siswa','pelatih') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'siswa',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Dumping data for table db_prestasi_beladiri.users: ~7 rows (approximately)
INSERT INTO `users` (`id`, `username`, `email`, `password`, `role`, `created_at`, `foto_profil`, `login_count`, `last_login`, `is_deleted`) VALUES
	(1, 'admin', 'admin@gmail.com', '$2y$10$zDV0E0SGG6OFdfEK67SbMu2SxpbyVJY1/vwuEDY2XpHyEA.9zKoKm', 'admin', '2025-12-17 06:26:14', 'profile_1_1767671267.png', 35, '2026-03-16 09:29:06', 0),
	(2, 'siswa1', 'school.muhammad.solikhin@gmail.com', '$2y$10$LSTFVDcTFn21sJmF4KVjJON.Virx4B0/eL6QGeHsagXknDqqbPm22', 'siswa', '2025-12-17 06:26:14', 'profile_2_1768285620.jpg', 18, '2026-03-10 11:42:29', 0),
	...
	(19, 'dztsaqibk', 'dzultsaqib@gmail.com', '$2y$10$f35MdjyoFoSMhpfbeqE5fO.e0pi8QSLiXpwRBYAIUh8eOLpRFsoIi', 'siswa', '2026-01-16 00:32:48', 'profile_19_1768548997.jpeg', 3, '2026-01-26 12:15:36', 0),
	(20, 'test489', NULL, '$2y$10$IirAMV.VgkmVji6XzBGKOOYULM9alvOnnz2CwPjB8Wn184zqERl6C', 'siswa', '2026-02-11 16:22:13', NULL, 0, NULL, 1),
	(21, 'pelatih1', 'ajeng@gmail.com', '$2y$10$AOTqvIT1rarOUmWytDeb8uWUWWG2ozrss5q7x8eeznh2cTB1Jmk52', 'pelatih', '2026-03-11 03:58:13', NULL, 3, '2026-03-12 09:39:22', 0),
	(22, 'pelatih2', 'pelatih2@gmail.com', '$2y$10$NWZSCXgor7TrxPuG5MNhm.N1VTy07eCxnIbyNfB3pJwMPm6GnPBvu', 'pelatih', '2026-03-12 06:16:39', NULL, 2, '2026-03-12 14:30:21', 0),
	(24, 'pelatih3', 'pelatih3@gmail.com', '$2y$10$62TDKRxorlX/mMeXHFaecOOS47caeS4qwk31s1K6Ps2dcleFTw/ny', 'pelatih', '2026-03-12 15:59:59', NULL, 1, '2026-03-12 23:00:09', 0),
	(25, 'eko', 'eko@gmail.com', '$2y$10$Yt/jfGGfv7qTQuVh0ZddYOtaQ8PjU8J35jKhwelBYG3byM8Bw7nHi', 'pelatih', '2026-03-16 02:33:03', NULL, 0, NULL, 0);
